  ...
  <body>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="?page=class"><img class="menu-icon" src="../vendor/images/menu_icons/02.png" alt="menu icon"> <span class="menu-title">CLASS</span></a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="?page=materi"> <img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">MATERI</span>
              </a>
            </li>
            <li class="nav-item">
    ...
    <div class="main-panel">
      ...
      if ($page == 'perangkat') {
        ...
        if ($act == '') {
          include 'modul/class/data_class.php';
        }
      } elseif ($page == 'mapel') {
        if ($act == '') {
